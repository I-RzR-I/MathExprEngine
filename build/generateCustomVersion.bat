...
set applicationName=MathExprEngine
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\MathExprEngine\MathExprEngine.csproj')
set testProjectsPath=$('..\src\tests\MathExprEngineTests\MathExprEngineTests.csproj')
